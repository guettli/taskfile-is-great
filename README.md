...
One feature I still miss is native support for "skip this task unless files in this path changed
...
The script stores a stamp file after a successful run and checks whether any tracked or untracked,
non-ignored file under the target path is newer than that stamp.
